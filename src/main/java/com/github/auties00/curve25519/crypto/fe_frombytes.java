...
//CONVERT #include "long.h"
    ...
    */
    public static void fe_frombytes(int[] h, byte[] s, int sOffset) {
        long h0 = load_4(s, sOffset);
        long h1 = load_3(s, sOffset + 4) << 6;
        long h2 = load_3(s, sOffset + 7) << 5;
        long h3 = load_3(s, sOffset + 10) << 3;
        long h4 = load_3(s, sOffset + 13) << 2;
        long h5 = load_4(s, sOffset + 16);
        long h6 = load_3(s, sOffset + 20) << 7;
        long h7 = load_3(s, sOffset + 23) << 5;
        long h8 = load_3(s, sOffset + 26) << 4;
        long h9 = (load_3(s, sOffset + 29) & 8388607) << 2;
        long carry0;
        long carry1;
        long carry2;
        long carry3;
