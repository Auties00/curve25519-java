...
public class ge_scalarmult {
    ...
    static void select(ge_cached t, ge_cached[] pre, byte b) {
        ...
        int bnegative = ge_scalarmult_base.negative(b);
        ...
        cmov(t, pre[0], ge_scalarmult_base.equal((byte) babs, (byte) 1));
        cmov(t, pre[1], ge_scalarmult_base.equal((byte) babs, (byte) 2));
        cmov(t, pre[2], ge_scalarmult_base.equal((byte) babs, (byte) 3));
        cmov(t, pre[3], ge_scalarmult_base.equal((byte) babs, (byte) 4));
        cmov(t, pre[4], ge_scalarmult_base.equal((byte) babs, (byte) 5));
        cmov(t, pre[5], ge_scalarmult_base.equal((byte) babs, (byte) 6));
        cmov(t, pre[6], ge_scalarmult_base.equal((byte) babs, (byte) 7));
        cmov(t, pre[7], ge_scalarmult_base.equal((byte) babs, (byte) 8));
